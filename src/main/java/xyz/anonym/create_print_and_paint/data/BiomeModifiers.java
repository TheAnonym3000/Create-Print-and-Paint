...
public class BiomeModifiers {
    ...
    private static ResourceKey<BiomeModifier> key(String name) {
        return ResourceKey.create(NeoForgeRegistries.Keys.BIOME_MODIFIERS, ResourceLocation.fromNamespaceAndPath(Create_Print_and_Paint.MODID, name));
    }
    public static void bootstrap(BootstrapContext<BiomeModifier> ctx) {
        ...
        Holder<PlacedFeature> aluminumOre = featureLookup.getOrThrow(PlacedFeatures.ALUMINUM_ORE);
